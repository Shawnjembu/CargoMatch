    ...
    return (
      <div className="min-h-screen bg-cream font-body">
        ...
        <div className="max-w-lg mx-auto px-6 pt-40 pb-16 text-center">
          ...
          <h1 className="font-display text-2xl font-800 text-stone-900 mb-2">Subscription activated!</h1>
          <p className="text-stone-500 text-sm mb-1">Welcome to the {success} plan.</p>
          <p className="text-stone-400 text-xs">Redirecting to your dashboard…</p>
        </div>
      </div>
    )
  }
          ...
          {PLANS.map(plan => {
            ...
            return (
              ...
              >
                ...
                {/* CTA / Google Pay confirm step */}
                {isSelected ? (
                  <div className="space-y-3">
                    <p className="text-xs text-stone-500 text-center">
                      Subscribing to <strong>{plan.name}</strong> — P {plan.price}/month
                    </p>
                    {paying ? (
                      ...
                      <div ref={isSelected ? gpayBtnRef : null} className="w-full min-h-[48px]" />
                    )}
                    <button
